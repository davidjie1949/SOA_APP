...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::ford::av::taas::PublishActiveTripInfo_TripActiveInfo, dropoff_location_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 96, -1, sizeof(::ford::av::taas::PublishOnboardingInfo_TripOnboardInfo)},
  { 109, -1, sizeof(::ford::av::taas::PublishOnboardingInfo)},
  { 117, -1, sizeof(::ford::av::taas::PublishMrc)},
  { 132, -1, sizeof(::ford::av::taas::PublishDriveUpdates)},
  { 141, -1, sizeof(::ford::av::taas::PublishOffboardingTrips)},
  { 148, -1, sizeof(::ford::av::taas::PublishActiveTripInfo_TripActiveInfo)},
  { 157, -1, sizeof(::ford::av::taas::PublishActiveTripInfo)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "\013pickup_name\030\005 \001(\t\022\027\n\017pickup_location\030\006 "
      "\001(\014\022\030\n\020dropoff_location\030\007 \001(\014\022\024\n\014dropoff"
      "_name\030\010 \001(\t\"\342\006\n\nPublishMrc\0221\n\r__api_vers"
      "ion\030\001 \001(\0132\032.ford.av.taas.__ApiVersion\022B\n"
      "\021fault_description\030\002 \001(\0162\'.ford.av.taas."
      "PublishMrc.MrcDescription\022\021\n\tcompleted\030\003"
      " \001(\010\0229\n\013recoverable\030\004 \001(\0162$.ford.av.taas"
      ".PublishMrc.Recoverable\022\022\n\ndoors_open\030\005 "
      "\001(\010\022\027\n\017leo_stop_active\030\006 \001(\010\0224\n\tpes_stat"
      "e\030\007 \001(\0162!.ford.av.taas.PublishMrc.PesSta"
      "te\022\031\n\021cloud_stop_active\030\010 \001(\010\022J\n\024conveni"
      "ence_pullover\030\t \001(\0162,.ford.av.taas.Publi"
      "shMrc.ConveniencePullover\022\025\n\rliftgate_op"
      "en\030\n \001(\010\"}\n\016MrcDescription\022\n\n\006NORMAL\020\000\022\022"
      "\n\016FAULT_PULLOVER\020\001\022\021\n\rFAULT_IN_LINE\020\002\022\030\n"
      "\024IMPACT_VDS_SUSPECTED\020\003\022\016\n\nIMPACT_VDS\020\004\022"
      "\016\n\nIMPACT_RCM\020\005\"\214\001\n\013Recoverable\022\024\n\020NULL_"
      "RECOVERABLE\020\000\022\023\n\017NON_RECOVERABLE\020\001\022\031\n\025VD"
      "S_RECOVERY_REQUIRED\020\002\022\033\n\027CLOUD_RECOVERY_"
      "REQUIRED\020\003\022\032\n\026DUAL_RECOVERY_REQUIRED\020\004\"E"
      "\n\010PesState\022\020\n\014PES_INACTIVE\020\000\022\027\n\023SINGLE_P"
      "RESS_PROMPT\020\001\022\016\n\nPES_ACTIVE\020\002\"Y\n\023Conveni"
      "encePullover\022 \n\034CONVENIENCEPULLOVER_INAC"
      "TIVE\020\000\022\016\n\nACTIVE_DXP\020\001\022\020\n\014ACTIVE_Cloud\020\002"
      "\"\216\001\n\023PublishDriveUpdates\0221\n\r__api_versio"
      "n\030\001 \001(\0132\032.ford.av.taas.__ApiVersion\022\030\n\020a"
      "rrival_imminent\030\002 \001(\010\022\013\n\003eta\030\003 \001(\r\022\035\n\025st"
      "op_location_updated\030\004 \001(\010\"j\n\027PublishOffb"
      "oardingTrips\0221\n\r__api_version\030\001 \001(\0132\032.fo"
      "rd.av.taas.__ApiVersion\022\034\n\024trip_ids_offb"
      "oarding\030\002 \003(\014\"\371\001\n\025PublishActiveTripInfo\022"
      "1\n\r__api_version\030\001 \001(\0132\032.ford.av.taas.__"
      "ApiVersion\022L\n\020trip_active_info\030\002 \003(\01322.f"
      "ord.av.taas.PublishActiveTripInfo.TripAc"
      "tiveInfo\032_\n\016TripActiveInfo\022\017\n\007trip_id\030\001 "
      "\001(\014\022\025\n\rdrop_off_name\030\002 \001(\t\022\030\n\020dropoff_lo"
      "cation\030\003 \001(\014\022\013\n\003eta\030\004 \001(\rP\000b\006proto3"
  };
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const PublishMrc_MrcDescription PublishMrc::NORMAL;
const PublishMrc_MrcDescription PublishMrc::FAULT_PULLOVER;
const PublishMrc_MrcDescription PublishMrc::FAULT_IN_LINE;
const PublishMrc_MrcDescription PublishMrc::IMPACT_VDS_SUSPECTED;
const PublishMrc_MrcDescription PublishMrc::IMPACT_VDS;
const PublishMrc_MrcDescription PublishMrc::IMPACT_RCM;
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const PublishMrc_Recoverable PublishMrc::NULL_RECOVERABLE;
const PublishMrc_Recoverable PublishMrc::NON_RECOVERABLE;
const PublishMrc_Recoverable PublishMrc::VDS_RECOVERY_REQUIRED;
const PublishMrc_Recoverable PublishMrc::CLOUD_RECOVERY_REQUIRED;
const PublishMrc_Recoverable PublishMrc::DUAL_RECOVERY_REQUIRED;
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const PublishMrc_PesState PublishMrc::PES_INACTIVE;
const PublishMrc_PesState PublishMrc::SINGLE_PRESS_PROMPT;
const PublishMrc_PesState PublishMrc::PES_ACTIVE;
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const PublishMrc_ConveniencePullover PublishMrc::CONVENIENCEPULLOVER_INACTIVE;
const PublishMrc_ConveniencePullover PublishMrc::ACTIVE_DXP;
const PublishMrc_ConveniencePullover PublishMrc::ACTIVE_Cloud;
...
PublishOnboardingInfo_TripOnboardInfo::PublishOnboardingInfo_TripOnboardInfo(const PublishOnboardingInfo_TripOnboardInfo& from)
  ...
  pickup_location_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (from.pickup_location().size() > 0) {
    pickup_location_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.pickup_location_);
  }
  dropoff_location_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (from.dropoff_location().size() > 0) {
    dropoff_location_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.dropoff_location_);
  }
...
void PublishOnboardingInfo_TripOnboardInfo::SharedDtor() {
  ...
  pickup_location_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  dropoff_location_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadBytes(
                input, this->mutable_pickup_location()));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 7: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadBytes(
                input, this->mutable_dropoff_location()));
        } else {
          goto handle_unusual;
        }
        break;
...
void PublishOnboardingInfo_TripOnboardInfo::SerializeWithCachedSizes(
  ...
  // bytes pickup_location = 6;
  if (this->pickup_location().size() > 0) {
    ::google::protobuf::internal::WireFormatLite::WriteBytesMaybeAliased(
      6, this->pickup_location(), output);
  }

  // bytes dropoff_location = 7;
  if (this->dropoff_location().size() > 0) {
    ::google::protobuf::internal::WireFormatLite::WriteBytesMaybeAliased(
      7, this->dropoff_location(), output);
  }
...
::google::protobuf::uint8* PublishOnboardingInfo_TripOnboardInfo::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->dropoff_location().size() > 0) {
    target =
      ::google::protobuf::internal::WireFormatLite::WriteBytesToArray(
        7, this->dropoff_location(), target);
  }
...
void PublishOnboardingInfo_TripOnboardInfo::InternalSwap(PublishOnboardingInfo_TripOnboardInfo* other) {
  ...
  pickup_location_.Swap(&other->pickup_location_);
  dropoff_location_.Swap(&other->dropoff_location_);
...
const int PublishActiveTripInfo_TripActiveInfo::kDropoffLocationFieldNumber;
...
void PublishActiveTripInfo_TripActiveInfo::SerializeWithCachedSizes(
  ...
  if (this->dropoff_location().size() > 0) {
    ::google::protobuf::internal::WireFormatLite::WriteBytesMaybeAliased(
      3, this->dropoff_location(), output);
  }
...
::google::protobuf::uint8* PublishActiveTripInfo_TripActiveInfo::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->dropoff_location().size() > 0) {
    target =
      ::google::protobuf::internal::WireFormatLite::WriteBytesToArray(
        3, this->dropoff_location(), target);
  }
