...
enum PublishMrc_MrcDescription {
  PublishMrc_MrcDescription_NORMAL = 0,
  PublishMrc_MrcDescription_FAULT_PULLOVER = 1,
  PublishMrc_MrcDescription_FAULT_IN_LINE = 2,
  PublishMrc_MrcDescription_IMPACT_VDS_SUSPECTED = 3,
  PublishMrc_MrcDescription_IMPACT_VDS = 4,
  PublishMrc_MrcDescription_IMPACT_RCM = 5,
...
const PublishMrc_MrcDescription PublishMrc_MrcDescription_MrcDescription_MIN = PublishMrc_MrcDescription_NORMAL;
const PublishMrc_MrcDescription PublishMrc_MrcDescription_MrcDescription_MAX = PublishMrc_MrcDescription_IMPACT_RCM;
...
enum PublishMrc_Recoverable {
  PublishMrc_Recoverable_NULL_RECOVERABLE = 0,
  PublishMrc_Recoverable_NON_RECOVERABLE = 1,
  PublishMrc_Recoverable_VDS_RECOVERY_REQUIRED = 2,
  PublishMrc_Recoverable_CLOUD_RECOVERY_REQUIRED = 3,
  PublishMrc_Recoverable_DUAL_RECOVERY_REQUIRED = 4,
...
const PublishMrc_Recoverable PublishMrc_Recoverable_Recoverable_MIN = PublishMrc_Recoverable_NULL_RECOVERABLE;
const PublishMrc_Recoverable PublishMrc_Recoverable_Recoverable_MAX = PublishMrc_Recoverable_DUAL_RECOVERY_REQUIRED;
...
enum PublishMrc_PesState {
  PublishMrc_PesState_PES_INACTIVE = 0,
  PublishMrc_PesState_SINGLE_PRESS_PROMPT = 1,
  PublishMrc_PesState_PES_ACTIVE = 2,
...
const PublishMrc_PesState PublishMrc_PesState_PesState_MIN = PublishMrc_PesState_PES_INACTIVE;
const PublishMrc_PesState PublishMrc_PesState_PesState_MAX = PublishMrc_PesState_PES_ACTIVE;
...
enum PublishMrc_ConveniencePullover {
  PublishMrc_ConveniencePullover_CONVENIENCEPULLOVER_INACTIVE = 0,
  PublishMrc_ConveniencePullover_ACTIVE_DXP = 1,
  PublishMrc_ConveniencePullover_ACTIVE_Cloud = 2,
...
const PublishMrc_ConveniencePullover PublishMrc_ConveniencePullover_ConveniencePullover_MIN = PublishMrc_ConveniencePullover_CONVENIENCEPULLOVER_INACTIVE;
const PublishMrc_ConveniencePullover PublishMrc_ConveniencePullover_ConveniencePullover_MAX = PublishMrc_ConveniencePullover_ACTIVE_Cloud;
...
class PublishOnboardingInfo_TripOnboardInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo) */ {
 public:
  ...
  // bytes pickup_location = 6;
  void clear_pickup_location();
  static const int kPickupLocationFieldNumber = 6;
  const ::std::string& pickup_location() const;
  void set_pickup_location(const ::std::string& value);
  #if LANG_CXX11
  void set_pickup_location(::std::string&& value);
  #endif
  void set_pickup_location(const char* value);
  void set_pickup_location(const void* value, size_t size);
  ::std::string* mutable_pickup_location();
  ::std::string* release_pickup_location();
  void set_allocated_pickup_location(::std::string* pickup_location);

  // bytes dropoff_location = 7;
  void clear_dropoff_location();
  static const int kDropoffLocationFieldNumber = 7;
  const ::std::string& dropoff_location() const;
  void set_dropoff_location(const ::std::string& value);
  #if LANG_CXX11
  void set_dropoff_location(::std::string&& value);
  #endif
  void set_dropoff_location(const char* value);
  void set_dropoff_location(const void* value, size_t size);
  ::std::string* mutable_dropoff_location();
  ::std::string* release_dropoff_location();
  void set_allocated_dropoff_location(::std::string* dropoff_location);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr pickup_location_;
  ::google::protobuf::internal::ArenaStringPtr dropoff_location_;
...
class PublishMrc : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ford.av.taas.PublishMrc) */ {
 public:
  ...
  static const MrcDescription NORMAL =
    PublishMrc_MrcDescription_NORMAL;
  static const MrcDescription FAULT_PULLOVER =
    PublishMrc_MrcDescription_FAULT_PULLOVER;
  static const MrcDescription FAULT_IN_LINE =
    PublishMrc_MrcDescription_FAULT_IN_LINE;
  static const MrcDescription IMPACT_VDS_SUSPECTED =
    PublishMrc_MrcDescription_IMPACT_VDS_SUSPECTED;
  static const MrcDescription IMPACT_VDS =
    PublishMrc_MrcDescription_IMPACT_VDS;
  static const MrcDescription IMPACT_RCM =
    PublishMrc_MrcDescription_IMPACT_RCM;
  ...
  static const Recoverable NULL_RECOVERABLE =
    PublishMrc_Recoverable_NULL_RECOVERABLE;
  static const Recoverable NON_RECOVERABLE =
    PublishMrc_Recoverable_NON_RECOVERABLE;
  static const Recoverable VDS_RECOVERY_REQUIRED =
    PublishMrc_Recoverable_VDS_RECOVERY_REQUIRED;
  static const Recoverable CLOUD_RECOVERY_REQUIRED =
    PublishMrc_Recoverable_CLOUD_RECOVERY_REQUIRED;
  static const Recoverable DUAL_RECOVERY_REQUIRED =
    PublishMrc_Recoverable_DUAL_RECOVERY_REQUIRED;
  ...
  static const PesState PES_INACTIVE =
    PublishMrc_PesState_PES_INACTIVE;
  static const PesState SINGLE_PRESS_PROMPT =
    PublishMrc_PesState_SINGLE_PRESS_PROMPT;
  static const PesState PES_ACTIVE =
    PublishMrc_PesState_PES_ACTIVE;
  ...
  static const ConveniencePullover CONVENIENCEPULLOVER_INACTIVE =
    PublishMrc_ConveniencePullover_CONVENIENCEPULLOVER_INACTIVE;
  static const ConveniencePullover ACTIVE_DXP =
    PublishMrc_ConveniencePullover_ACTIVE_DXP;
  static const ConveniencePullover ACTIVE_Cloud =
    PublishMrc_ConveniencePullover_ACTIVE_Cloud;
...
class PublishActiveTripInfo_TripActiveInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ford.av.taas.PublishActiveTripInfo.TripActiveInfo) */ {
 public:
  ...
  // bytes dropoff_location = 3;
  void clear_dropoff_location();
  static const int kDropoffLocationFieldNumber = 3;
  const ::std::string& dropoff_location() const;
  void set_dropoff_location(const ::std::string& value);
  #if LANG_CXX11
  void set_dropoff_location(::std::string&& value);
...
inline void PublishOnboardingInfo_TripOnboardInfo::clear_pickup_location() {
  pickup_location_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& PublishOnboardingInfo_TripOnboardInfo::pickup_location() const {
  // @@protoc_insertion_point(field_get:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.pickup_location)
  return pickup_location_.GetNoArena();
}
inline void PublishOnboardingInfo_TripOnboardInfo::set_pickup_location(const ::std::string& value) {
  
  pickup_location_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.pickup_location)
}
#if LANG_CXX11
inline void PublishOnboardingInfo_TripOnboardInfo::set_pickup_location(::std::string&& value) {
  
  pickup_location_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.pickup_location)
}
#endif
inline void PublishOnboardingInfo_TripOnboardInfo::set_pickup_location(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  pickup_location_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.pickup_location)
}
inline void PublishOnboardingInfo_TripOnboardInfo::set_pickup_location(const void* value, size_t size) {
  
  pickup_location_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.pickup_location)
}
inline ::std::string* PublishOnboardingInfo_TripOnboardInfo::mutable_pickup_location() {
  
  // @@protoc_insertion_point(field_mutable:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.pickup_location)
  return pickup_location_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* PublishOnboardingInfo_TripOnboardInfo::release_pickup_location() {
  // @@protoc_insertion_point(field_release:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.pickup_location)
  
  return pickup_location_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void PublishOnboardingInfo_TripOnboardInfo::set_allocated_pickup_location(::std::string* pickup_location) {
  if (pickup_location != NULL) {
    
  } else {
    
  }
  pickup_location_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), pickup_location);
...
inline void PublishOnboardingInfo_TripOnboardInfo::clear_dropoff_location() {
  dropoff_location_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& PublishOnboardingInfo_TripOnboardInfo::dropoff_location() const {
  // @@protoc_insertion_point(field_get:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.dropoff_location)
  return dropoff_location_.GetNoArena();
}
inline void PublishOnboardingInfo_TripOnboardInfo::set_dropoff_location(const ::std::string& value) {
  
  dropoff_location_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.dropoff_location)
}
#if LANG_CXX11
inline void PublishOnboardingInfo_TripOnboardInfo::set_dropoff_location(::std::string&& value) {
  
  dropoff_location_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.dropoff_location)
}
#endif
inline void PublishOnboardingInfo_TripOnboardInfo::set_dropoff_location(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  dropoff_location_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.dropoff_location)
}
inline void PublishOnboardingInfo_TripOnboardInfo::set_dropoff_location(const void* value, size_t size) {
  
  dropoff_location_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.dropoff_location)
}
inline ::std::string* PublishOnboardingInfo_TripOnboardInfo::mutable_dropoff_location() {
  
  // @@protoc_insertion_point(field_mutable:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.dropoff_location)
  return dropoff_location_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* PublishOnboardingInfo_TripOnboardInfo::release_dropoff_location() {
  // @@protoc_insertion_point(field_release:ford.av.taas.PublishOnboardingInfo.TripOnboardInfo.dropoff_location)
  
  return dropoff_location_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void PublishOnboardingInfo_TripOnboardInfo::set_allocated_dropoff_location(::std::string* dropoff_location) {
  if (dropoff_location != NULL) {
    
  } else {
    
  }
  dropoff_location_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), dropoff_location);
...
// bytes dropoff_location = 3;
inline void PublishActiveTripInfo_TripActiveInfo::clear_dropoff_location() {
  dropoff_location_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& PublishActiveTripInfo_TripActiveInfo::dropoff_location() const {
  // @@protoc_insertion_point(field_get:ford.av.taas.PublishActiveTripInfo.TripActiveInfo.dropoff_location)
  return dropoff_location_.GetNoArena();
}
inline void PublishActiveTripInfo_TripActiveInfo::set_dropoff_location(const ::std::string& value) {
  
  dropoff_location_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:ford.av.taas.PublishActiveTripInfo.TripActiveInfo.dropoff_location)
}
#if LANG_CXX11
inline void PublishActiveTripInfo_TripActiveInfo::set_dropoff_location(::std::string&& value) {
  
  dropoff_location_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:ford.av.taas.PublishActiveTripInfo.TripActiveInfo.dropoff_location)
}
#endif
inline void PublishActiveTripInfo_TripActiveInfo::set_dropoff_location(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  dropoff_location_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ford.av.taas.PublishActiveTripInfo.TripActiveInfo.dropoff_location)
}
inline void PublishActiveTripInfo_TripActiveInfo::set_dropoff_location(const void* value, size_t size) {
  
  dropoff_location_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ford.av.taas.PublishActiveTripInfo.TripActiveInfo.dropoff_location)
}
inline ::std::string* PublishActiveTripInfo_TripActiveInfo::mutable_dropoff_location() {
  
  // @@protoc_insertion_point(field_mutable:ford.av.taas.PublishActiveTripInfo.TripActiveInfo.dropoff_location)
  return dropoff_location_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* PublishActiveTripInfo_TripActiveInfo::release_dropoff_location() {
  // @@protoc_insertion_point(field_release:ford.av.taas.PublishActiveTripInfo.TripActiveInfo.dropoff_location)
  
  return dropoff_location_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void PublishActiveTripInfo_TripActiveInfo::set_allocated_dropoff_location(::std::string* dropoff_location) {
  if (dropoff_location != NULL) {
  ...
  dropoff_location_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), dropoff_location);
  // @@protoc_insertion_point(field_set_allocated:ford.av.taas.PublishActiveTripInfo.TripActiveInfo.dropoff_location)
}
